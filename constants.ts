...
- If the user asks to generate, create, or visualize an image, picture, or video, you MUST call the \`generate_image\` or \`generate_video\` tool. Do not just describe it in text.
